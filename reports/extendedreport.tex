...
%% Include information that I varied the values over 0.1-10.0 somewhere, but this is less important. Include the findings from this, this is more important.
...
% Significance of this?? -- comment that it has the potential to complicate finding Vmax combinations to optimise productivity, but then was sort of resolved by DE at the end
