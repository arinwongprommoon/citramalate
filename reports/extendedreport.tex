...
Enzymes that have the largest shares of flux control as noted by \citet{millard_metabolic_2017} showed the largest effects on citramalate productivity. However, CYTBO had less effect on productivity as would be expected by this explanation. Although PYK did not exert a lot of control over fluxes as expected by its flux control coefficient, it had a large effect on citramalate productivity. %[Move this to discussion] Possibly it was because the citramalate reaction used up pyruvate and because PYK is a control point in glycolysis.
...
%% [Also shouldn't this be in like a different section e.g. the bit about the kinetic model?]
