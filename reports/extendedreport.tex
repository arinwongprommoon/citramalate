...
%% instead of this list, a diagram of what the hell I was trying to explain would be useful. I hand-drew this at some point, but tiks or some shit would be my friend
...
% put 41-dimension bounds in appendix
...
%   col sep = comma,
%   column type = r,
%   columns/Reac/.style = {string type},
...
]{41dBoundaries-fuckifthisdoesntwork.csv}
