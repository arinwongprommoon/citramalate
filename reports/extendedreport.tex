...
% This can be killed -- describes a previous method that did not work
...
However, the calculated maximum glucose uptake rate was very low, and the rates for for other chemicals present in the Lund medium were even lower.
