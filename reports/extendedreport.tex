...
%% FROM OLD ISSUES SECTION --> is a bit out of place here!!
...
% - resolves complications that (may) be introduced by inflection points
...
% Glycolytic enzymes
%[Add a little `primer' to remind people of results] This suggested that not all reactions in a network have to be included in differential evolution to produce valid results. The conclusion is beneficial as it reduces computation time needed to optimise citramalate productivity.
