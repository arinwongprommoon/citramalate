...
run = couples.Coupl(xstart=0.1, xend=1.0, ystart=0.1, yend=1.0, points=20) # define vmax ranges here
...
run.listofreactions = ['ATP_MAINTENANCE', 'GDH'] # define list of reactions
